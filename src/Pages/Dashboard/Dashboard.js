...
const Dashboard = ({profileData, fetchProfile}) => {
                    ...
                    <div className="notification-mobile">
                        <div className="notification-mobile-left">
                            ...
                            <div className="user-details">
                                ...
                                <p className="business-name">{profileData?.profile?.message?.profile?.businessName ?? "********"}</p>
                            </div>
                        </div>
                    ...
                    <div className="vault">
                        ...
                        <div className="vault-card">
                            <div className="vault-card-left">
                                <p className="card-balance">₦{profileData?.profile?.message?.profile?.vaults?.accountBalance ?? "********"}</p>
                                <p className="card-amount">Credio vault {profileData?.profile?.message?.profile?.vaults?.accountNumber ?? "********"}</p>
                            </div>
